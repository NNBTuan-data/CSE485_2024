...
<body>
    ...
    <main class="container mt-5">
        <!-- <h3 class="text-center text-uppercase mb-3 text-primary">CẢM NHẬN VỀ BÀI HÁT</h3> -->
                ...
                <div class="row mb-5">
                    <div class="col-sm-4">
                        <img src="../config/images/songs/csmt.jpg" class="img-fluid" alt="...">
                    </div>

                        <?php
                            $query = "SELECT * FROM baiviet JOIN tacgia ON baiviet.ma_tgia = tacgia.ma_tgia JOIN theloai ON baiviet.ma_tloai = theloai.ma_tloai WHERE ten_bhat = 'Ôi Cuộc Sống Mến Thương' ";
